...
- Mobile: keep week row stats inside the day header, remove blank space from empty expanded days, and replace month day dialogs with an inline day schedule below the calendar.
- Mobile: align task and subtask check circles with the first title line in compact cards.
