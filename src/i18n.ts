...
const EN = {
  ...
  "savedViews.queryEditorHelp": "Visual editing currently covers filters first. For the complete query, including view and summary, use the DSL entry below.",
...
const ZH: Partial<typeof EN> = {
  ...
  "savedViews.queryEditorHelp": "当前可视化优先编辑过滤条件；完整 Query 的 view / summary 请走下方 DSL 入口。",
